...
import me.choicore.likeapuppy.identityprovider.common.toNullable
...
class AuthenticationEventListener(
	 ...
	 * @return user
	 * @throws UnauthorizedException.UsernameNotFound if the user is not found
	 */
	@Throws(UnauthorizedException::class)
	private fun getUserInfo(identifier: String): User {
		return userRepository.findByIdentifier(identifier).toNullable() ?: throw UnauthorizedException.UsernameNotFound
	}
}